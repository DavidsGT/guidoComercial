...
<div id="pagos" class="tabcontent">
	<div class="row">
		...
		{!! Form::open(array('url'=>'compras/devoluciones','method'=>'POST','autocomplete'=>'off'))!!}
			{{Form::token()}}
	<div class="row">
		<div class="col-lg-4 col-mg-4 col-sg-4 col-xs-12">
			<div class="form-group">
				<label for="idingreso">Orden de Ingreso de Compra</label>
		...
		<div class="col-lg-4 col-mg-4 col-sg-4 col-xs-12">
			<div class="form-group">
				<label for="cantcompra">Cantidad de Compra</label>
