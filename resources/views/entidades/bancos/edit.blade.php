...
<div class="row">
	<div class="col-lg-6 col-mg-6 col-sg-6 col-xs-12">
		<h3>Editar Bancos: {{$bancos->nombre}} </h3>
		@if (count($errors)>0)
		...
		{!! Form::model($bancos,['method'=>'PATCH','route'=>['entidades.bancos.update',$bancos->identidad]]) !!}
			{{Form::token()}}
			<div class="col-lg-6 col-mg-6 col-sg-6 col-xs-12">
			...
			<div class="col-lg-6 col-mg-6 col-sg-6 col-xs-12">
				...
				<input type="text" name="numero" id="numero" class="form-control" value="{{$bancos->numero}}" placeholder="Numero....">		
				</div>
			</div>
			<div class="col-lg-6 col-mg-6 col-sg-6 col-xs-12">
				<div class="form-group">
				<label for="nombre">Banco</label>
				<input type="text" name="nombre" id="nombre" class="form-control" value="{{$bancos->nombre}}" placeholder="Banco....">		
				</div>
			</div>
