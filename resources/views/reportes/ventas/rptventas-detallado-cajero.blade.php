...
<body>
  <div id="header">
    ...
    <h4>REPORTE DE VENTAS DETALLADO POR CAJEROS</h4>
    ...
    @foreach ($ventas as $ven)
      @if (is_null($LastVen))
        <?php $CountFactVendedor = 1; $TotFactVendedor = $ven->total;
          $producto = [
            "nombre_producto" => $ven->nombre,
            "cantidad" =>$ven->cantidad,
            "preciounitario" => $ven->preciounitario,
          ...
          array_push($factura["productos"],$producto);
        ?>
              ...
              <tr>
                ...
                <table style="width: 100%">
                      ...
                      <tr>
                        ...
                        <td>{{ $pro["descuento"]}}</td>
                        <td>{{ $pro["tipoiva"]}}</td>
                        <td>{{ ($pro["cantidad"] * $pro["preciounitario"]) + (($pro["cantidad"] * $pro["preciounitario"])*$pro["tipoiva"]/100) - (($pro["cantidad"] * $pro["preciounitario"])*$pro["descuento"]/100)}}</td>      
                      </tr>
                      @endforeach
                      </tbody>
                </table>
